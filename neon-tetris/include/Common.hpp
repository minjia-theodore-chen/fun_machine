...
namespace NeonColors {
    ...
    inline std::string getShapeColor(TetrominoShape shape) {
        switch (shape) {
            case TetrominoShape::I: return CYAN;
            case TetrominoShape::O: return YELLOW;
            case TetrominoShape::T: return PURPLE;
            case TetrominoShape::S: return GREEN;
            case TetrominoShape::Z: return MAGENTA;
            case TetrominoShape::J: return BLUE;
            case TetrominoShape::L: return ORANGE;
